 ...
 */
export function detectMemoryWriteRequest(prompt        )          {
  const p = prompt ?? "";
...
export function memoriesRoot(env                    = process.env)         {
 ...
 */
export function isMemoryPath(candidate        , root        )          {
 ...
 */
function consumeAuthorization(cwd        , sessionId        , turnId        )          {
 ...
 */
export function handleMemoryWriteGate(raw        , env                    = process.env)         {
  try {
